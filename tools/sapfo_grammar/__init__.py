...
Build-time only: tools/build_composita.py uses it to decide whether a candidate
...
No lexicon row is read here, so nothing in this package carries SNK provenance.
